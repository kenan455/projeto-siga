        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <h1 class="pt-5 text-blue">Bem-vindo</h1>
          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
                ...
                <div class="text-center">
                  <a type="submit" class="btn btn-lg  btn-primary my-4 w-100" href="{{route('login.page')}}">PROFESSOR</a>
                </div>
                ...
                <div class="text-center">
                  <a type="submit" class="btn btn-lg  btn-primary my-4 w-100" href="{{route('login.aluno')}}">ALUNO   </a>
                </div>
