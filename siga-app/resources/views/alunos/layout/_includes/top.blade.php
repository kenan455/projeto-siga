      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link "  href="{{route('aluno.atividades')}}">
                <i class="fa fa-store-alt text-green"></i>
                <span class="nav-link-text">Atividades</span>
              </a>
            </li>
            <li class="nav-item">
            <a class="nav-link " href="{{route('aluno.contato_professor')}}">
                <i class="fa fa-cubes text-green"></i>
                <span class="nav-link-text">Contato com professor</span>
              </a>
            </li>
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link " href="{{route('aluno.mudar_senha')}}">
                  <i class="fa fa-key"></i>
                  <span class="nav-link-text">Mudar Senha</span>
              </a>
            </li>
            <li class="nav-item">
